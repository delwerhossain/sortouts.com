    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <h2>Hot Food Delivery Insurance</h2>
                <ul class="bread-list">
                    <li><a href="/">Home<i class="fa fa-angle-right"></i></a></li>
                    <li class="active"><a href="{{route('businessinsurance')}}">Hot Food Searches</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="services-main">
                    ...
                    <div class="services-slider">
                        ...
                        <div class="single-slide">
                          <a href="{{route('foodquote.index')}}"><img src="fontend/images/food1.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                        <!-- Single Slide -->
                        <div class="single-slide">
                          <a href="{{route('foodquote.index')}}"><img src="fontend/images/food2.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                    </div>
                    <!-- End Service Slider -->
                ...
                <div class="services-sidebar">
                    ...
                    <div class="single-sidebar category">
                        <ul class="ulStyle">
                            ...
                            <li><a href="{{route('carquote.index')}}"><i class="fa fa-bus"></i>Car Quote</a></li>
                            <li><a href="{{route('vanquote.index')}}"><i class="fa fa-taxi"></i>Van Quote</a></li>
                            <li><a href="{{route('bikequote.index')}}"><i class="fa fa-briefcase"></i>Bike Quote</a></li>
                    ...
                    <!--/ End Single Sidebar -->
                    <div>
                        <a href="{{route('foodquote.index')}}" class="btn btn-primary" style="width: 100%; margin-top: 10px;">GET HOT FOOD QOUTE NOW</a>
                    </div>
                    <!-- Single Sidebar -->
                    <div class="single-sidebar service" style="margin-top: 10px;">
                        <h2><span>More Service</span></h2>
                        <div class="single-service">
                            <a href="{{route('carinsurance')}}"><img src="fontend/images/more/car.jpg" alt="" /></a>
                            <div class="caption">
                                <p><a href="service-single.html">Car Insurance</a></p>
                            </div>
                        </div>
                        <div class="single-service">
