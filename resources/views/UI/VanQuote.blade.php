...
<section class="services single section">
    <div id="divVanQuote" name="divVanQuote" class="container">
        ...
        @else
        <div class="row">
            <h3 style="font-weight: 600; text-align: center;">Van Insurance Quotation Form</h3>
        </div>
        <x-alert />
        <br>
        <br>
        ...
        <div class="row ">
            <div class="col-sm-12">
                <form method="post" action="{{route('vanquote.store')}}">
                    @csrf
                    <!-- <div id="divCarQuote"> -->
                                ...
                                <div id="divConvictionDetails" class="form-group row hidden">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Date Of Conviction :</label>
                                                <input name="convictionDate3" type="text" id="convictionDate3" class="form-controldatePick">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Points :</label>
                    ...
                    <div class="row setup-content" id="step-3">
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Manufacturer :</label>
                                    <label name="oldManufactur" class="hidden" text="{{ old('manufactur') }}"></label>
                                    <div class="col-sm-8">
                                        <select name="manufactur" id="manufactur" class="form-control fieldwidth">
                                            @if(old('manufactur') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('manufactur') }}" selected>{{ old('manufactur') }}</option>
                                            @endif
                                            ...
                                            <option value="Coleman Milne">Coleman Milne</option>
                                            ...
                                            <option value="HyundaiInfiniti">HyundaiInfiniti</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="vModel" type="text" id="vModel" class="form-control fieldwidth" value="{{ old('vModel') }}" placeholder="Vehicle Model">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Registration Year :</label>
                                    <div class="col-sm-8">
                                        <input name="regYear" type="text" id="regYear" class="form-control fieldwidth datePick" value="{{ old('regYear') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Alarms - Immobiliser :</label>
                                    <div class="col-sm-8">
                                        <select name="immobiliser" id="immobiliser" class="form-control fieldwidth">
                                            @if(old('immobiliser') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('immobiliser') }}" selected>{{ old('immobiliser') }}</option>
                                            @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Number of Seats :</label>
                                    <div class="col-sm-8">
                                        <select name="seats" id="seats" class="form-control fieldwidth">
                                            @if(old('seats') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('seats') }}" selected>{{ old('seats') }}</option>
                                            @endif
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                            <option value="3">3</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Number of Doors :</label>
                                    <div class="col-sm-8">
                                        <select name="doorNo" id="doorNo" class="form-control fieldwidth">
                                            @if(old('doorNo') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('doorNo') }}" selected>{{ old('doorNo') }}</option>
                                            @endif
                                            <option value="2 Doors">2Doors</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Engine Size (CC) :</label>
                                    <div class="col-sm-8">
                                        <input name="engineSize" type="text" id="engineSize" class="form-control fieldwidth" value="{{ old('engineSize') }}" placeholder="Vehicle Model">
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label class="col-sm-4 col-form-label control-label">Transmission :</label>
                                    <div class="col-sm-8">
                                        <label class="radio-inline">
                                            <input id="rdbManual" type="radio" name="transmission" value="manual" checked="checked"><label for="rdbManual">Manual</label>
                                        </label>
                                        <label class="radio-inline">
                                            <input id="rdbAuto" type="radio" name="transmission" value="auto"><label for="rdbAuto">Automatic</label>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Fuel Type :</label>
                                    <div class="col-sm-8">
                                        <select name="fuelType" id="fuelType" class="form-control fieldwidth">
                                            @if(old('fuelType') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('fuelType') }}" selected>{{ old('fuelType') }}</option>
                                            @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Body Type <span style="color: red">*</span> :</label>
                                    <div class="col-sm-8">
                                        <select name="bodyType" id="bodyType" class="form-control fieldwidth">
                                            @if(old('bodyType') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('bodyType') }}" selected>{{ old('bodyType') }}</option>
                                            @endif
                                            ...
                                            <option value="Hot food Dispenser">Hot food Dispenser</option>
                                            <option value="Ice Cream Van">Ice Cream Van</option>
                                            <option value="Loader">Loader</option>
                                            <option value="Milk Float">Milk Float</option>
                                            <option value="Mobile Shop">Mobile Shop</option>
                                            <option value="Refrigerated / Insulated">Refrigerated / Insulated</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Roof Type <span style="color: red">*</span> :</label>
                                    <div class="col-sm-8">
                                        <select name="roofType" id="roofType" class="form-control fieldwidth">
                                            @if(old('roofType') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('roofType') }}" selected>{{ old('roofType') }}</option>
                                            @endif
                                            <option value="Normal Roof">Normal Roof</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Wheel Base <span style="color: red">*</span> :</label>
                                    <div class="col-sm-8">
                                        <select name="wheel" id="wheel" class="form-control fieldwidth">
                                            @if(old('wheel') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('wheel') }}" selected>{{ old('wheel') }}</option>
                                            @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Is the car impounded with the police?</label>
                                    <div class="col-sm-8">
                                        <select name="impoundWithPolice" id="impoundWithPolice" class="form-control fieldwidth">
                                            @if(old('impoundWithPolice') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('impoundWithPolice') }}" selected>{{ old('impoundWithPolice') }}</option>
                                            @endif
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                ...
                                <div class="form-group row hidden">
                                    <label class="col-sm-4 col-form-label control-label">How did you earn your no claims discount <span style="color: red">*</span> :</label>
                                    <div class="col-sm-8">
                                        <select name="howClaimDiscount" id="howClaimDiscount" class="form-control fieldwidth">
                                            @if(old('howClaimDiscount') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('howClaimDiscount') }}" selected>{{ old('howClaimDiscount') }}</option>
                                            @endif
