...
<head>
    ...
    <title>Motor Quote Document</title>

</head>

<body>
    <div>
        <h1 style="margin-top:0pt; margin-bottom:14pt;"><span style="font-family:'Times New Roman';">Motor Trade Insurance form, submitted by&nbsp;</span><span style="font-family:'Times New Roman'; color:#3380ff;">{{$firstName }} {{$lastName }}</span></h1>
        ...
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Do you do only buying and selling or vehicle recovery as well? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$tradeType }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Do you do trading from home? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;&pound; {{$isTradeFrmHome }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">If no please describe :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$ifNotFrmHome }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Are you Trading as Limited Company or Sole Trader? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$companyType }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">If you have a trading name, Please state it :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$tradeName }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Do you have a recovery truck? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$haveRecoveryTruck }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">If yes, What is the Make and Model :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$truckModel }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Have you ever had a Motor Trade Policy? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$isPolicyExist }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">If yes, Who was your Insurer Previously? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$prevPolicyInsureName }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Approximately, How Many Cars do you Sell in a Month? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$approxCarSell }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Vehicle registrations at the Present :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$vReg1 }} ,{{$vReg2 }} ,{{$vReg3 }} ,{{$vReg4 }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">How Many Cars do You Keep in your Possession at a time? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$carAtaTimeKeep }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Where do you keep the car? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$garageDetails }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">If you have garage or driveway, how many cars it can hold at a time? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$garageCapacity }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Whats the maximum individual value of the cars you hold? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$individualCarMaxQty }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Do you require demonstration cover? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$isCoverReq }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Do you sell any Motor Bike, HGV, Classic or Sports cars or any vehicle over 3.5 ton? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;&pound;{{$doSellVehOver3Ton }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">What Type of Cover do you Prefer? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;&pound;{{$prefferedCover }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Do you have No Claim Bonus on Motor Trade policy? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;&pound;{{$isClaimBonusMotor }}</span></p>
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Do you have No Claim Bonus on Private car (even presently in use on another car/van)? :</span></strong><span style="font-family:'Times New Roman';">&nbsp;&pound;{{$isClaimBonusCar }}</span></p>
