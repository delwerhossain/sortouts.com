...
<section class="services single section">
    <div id="divVanQuote" name="divVanQuote" class="container">
        ...
        @else
        <div class="row">
            <h3 style="font-weight: 600; text-align: center;">Car Insurance Quotation Form</h3>
        </div>
        <x-alert />
        <br>
        <br>
        ...
        <div class="row ">
            <div class="col-sm-12">
                <form method="post" action="{{route('carquote.store')}}">
                    @csrf
                    <!-- <div id="divCarQuote"> -->
                    ...
                    <div class="row setup-content" id="step-3">
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">What do you use the car for? <span style="color: red">*</span> :</label>
                                    <div class="col-sm-8">
