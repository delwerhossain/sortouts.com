...
<section class="services single section">
    <div id="divVanQuote" name="divVanQuote" class="container">
        ...
        @else
        <div class="row">
            <h3 style="font-weight: 600; text-align: center;">Motor Insurance Quotation Form</h3>
        </div>
        <x-alert />
        <br>
        <br>
        ...
        <div class="row ">
            <div class="col-sm-12">
                <form method="post" action="{{route('motorquote.store')}}">
                    @csrf
                    <!-- <div id="divCarQuote"> -->
                        ...
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="email" type="email" id="email" class="form-control fieldwidth" required value="{{ old('email') }}">
                                        @error('email')
                                        <div class="alert-danger fieldwidth">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div id="divConvictionDetails" class="form-group row hidden">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Date Of Conviction :</label>
                                                <input name="convictionDate2" type="text" id="convictionDate2" class="form-control datePickPast">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Points :</label>
                    ...
                    <div class="row setup-content" id="step-3">
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row ">
                                    <label class="col-sm-4 col-form-label control-label">Do you do only buying and selling or vehicle recovery as well?</label>
                                    <div class="col-sm-8">
                                        <select name="tradeType" id="tradeType" class="form-control fieldwidth">
                                            @if(old('tradeType') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('tradeType') }}" selected>{{ old('tradeType') }}</option>
                                            @endif
                                            <option value="Buying and Selling only" class="dropdown-item">Buying and Selling only</option>
                                            <option value="Both Buying, Selling and Vehicle Recovery" class="dropdown-item">Both Buying, Selling and Vehicle Recovery</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Do you do trading from home?</label>
                                    <div class="col-sm-8">
                                        <select name="isTradeFrmHome" id="isTradeFrmHome" class="form-control fieldwidth">
                                            @if(old('isTradeFrmHome') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('isTradeFrmHome') }}" selected>{{ old('isTradeFrmHome') }}</option>
                                            @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">If no please describe :</label>
                                    <div class="col-sm-8">
                                        <input name="ifNotFrmHome" type="text" id="ifNotFrmHome" class="form-control fieldwidth" value="{{ old('ifNotFrmHome') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Are you Trading as Limited Company or Sole Trader?</label>
                                    <div class="col-sm-8">
                                        <select name="companyType" id="companyType" class="form-control fieldwidth" required>
                                            @if(old('companyType') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('companyType') }}" selected>{{ old('companyType') }}</option>
                                            @endif
                                            <option value="Limited Company">Limited Company</option>
                                            <option value="Sole Trader">Sole Trader</option>
                                        </select>If you have a trading name, Please state it
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">If you have a trading name, Please state it :</label>
                                    <div class="col-sm-8">
                                        <input name="tradeName" type="text" id="tradeName" class="form-control fieldwidth" value="{{ old('tradeName') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Do you have a recovery truck?</label>
                                    <div class="col-sm-8">
                                        <select name="haveRecoveryTruck" id="haveRecoveryTruck" class="form-control fieldwidth">
                                            @if(old('haveRecoveryTruck') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('haveRecoveryTruck') }}" selected>{{ old('haveRecoveryTruck') }}</option>
                                            @endif
                                            <option value="Yes" class="dropdown-item">Yes</option>
                                            <option value="No" class="dropdown-item">No</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">If yes, What is the Make and Model :</label>
                                    <div class="col-sm-8">
                                        <input name="truckModel" type="text" id="truckModel" class="form-control fieldwidth" value="{{ old('truckModel') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Have you ever had a Motor Trade Policy?</label>
                                    <div class="col-sm-8">
                                        <select name="isPolicyExist" id="isPolicyExist" class="form-control fieldwidth">
                                            @if(old('isPolicyExist') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('isPolicyExist') }}" selected>{{ old('isPolicyExist') }}</option>
                                            @endif
                                            <option value="Yes" class="dropdown-item">Yes</option>
                                            <option value="No" class="dropdown-item">No</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">If yes, Who was your Insurer Previously?</label>
                                    <div class="col-sm-8">
                                        <input name="prevPolicyInsureName" type="text" id="prevPolicyInsureName" class="form-control fieldwidth" value="{{ old('prevPolicyInsureName') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Approximately, How Many Cars do you Sell in a Month?</label>
                                    <div class="col-sm-8">
                                        <input name="approxCarSell" type="number" id="approxCarSell" class="form-control fieldwidth" value="{{ old('approxCarSell') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Vehicle registrations at the Present :</label>
                                    <div class="col-sm-8">
                                        <input name="vReg1" type="text" id="vReg1" class="form-control fieldwidth" placeholder="Vehicle Registration 1" value="{{ old('vReg1') }}">
                                        <input name="vReg2" type="text" id="vReg2" class="form-control fieldwidth" placeholder="Vehicle Registration 2" value="{{ old('vReg2') }}">
                                        <input name="vReg3" type="text" id="vReg3" class="form-control fieldwidth" placeholder="Vehicle Registration 3" value="{{ old('vReg3') }}">
                                        <input name="vReg4" type="text" id="vReg4" class="form-control fieldwidth" placeholder="Vehicle Registration 4" value="{{ old('vReg4') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">How Many Cars do You Keep in your Possession at a time?</label>
                                    <div class="col-sm-8">
                                        <input name="carAtaTimeKeep" type="number" id="carAtaTimeKeep" class="form-control fieldwidth" value="{{ old('carAtaTimeKeep') }}">
                                    </div>
                                </div>

                                <div class="form-group row ">
                                    <label class="col-sm-4 col-form-label control-label">Where do you keep the car? Please specify :</label>
                                    <div class="col-sm-8">
                                        <input name="garageDetails" type="text" id="garageDetails" class="form-control fieldwidth" value="{{ old('garageDetails') }}">

                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label class="col-sm-4 col-form-label control-label">If you have garage or driveway, how many cars it can hold at a time?</label>
                                    <div class="col-sm-8">
                                        <input name="garageCapacity" type="number" id="garageCapacity" class="form-control fieldwidth" value="{{ old('garageCapacity') }}">
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label class="col-sm-4 col-form-label control-label">Whats the maximum individual value of the cars you hold?</label>
                                    <div class="col-sm-8">
                                        <input name="individualCarMaxQty" type="number" id="individualCarMaxQty" class="form-control fieldwidth" value="{{ old('individualCarMaxQty') }}">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Do you require demonstration cover?</label>
                                    <div class="col-sm-8">
                                        <select name="isCoverReq" id="isCoverReq" class="form-control fieldwidth">
                                            @if(old('isCoverReq') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('isCoverReq') }}" selected>{{ old('isCoverReq') }}</option>
                                            @endif
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
                                ...
                                <div class="form-group row ">
                                    <label class="col-sm-4 col-form-label control-label">Do you sell any Motor Bike, HGV, Classic or Sports cars or any vehicle over 3.5 ton?(If yes please specify)</label>
                                    <div class="col-sm-8">
                                        <input name="doSellVehOver3Ton" type="text" id="doSellVehOver3Ton" class="form-control fieldwidth" value="{{ old('doSellVehOver3Ton') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">What Type of Cover do you Prefer?</label>
                                    <div class="col-sm-8">
                                        <select name="prefferedCover" id="prefferedCover" class="form-control fieldwidth">
                                            @if(old('prefferedCover') == "")
                                            <option value="" selected>----</option>
                                            @else
                                            <option value="{{ old('prefferedCover') }}" selected>{{ old('prefferedCover') }}</option>
                                            @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Do you have No Claim Bonus on Motor Trade policy?</label>
                                    <div class="col-sm-8">
                                        <input name="isClaimBonusMotor" type="text" id="isClaimBonusMotor" class="form-control fieldwidth" value="{{ old('isClaimBonusMotor') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Do you have No Claim Bonus on Private car (even presently in use on another car/van)?</label>
                                    <div class="col-sm-8">
                                        <input name="isClaimBonusCar" type="text" id="isClaimBonusCar" class="form-control fieldwidth" value="{{ old('isClaimBonusCar') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="divAdDrivers" class="row hidden">
                                    ...
                                    <div id="AdditionalDriver2" class="col-sm-12 hidden">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label control-label">Please enter your 16 character driving licence number</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="Additional_Driver_2_licenceNo" class="form-control " placeholder="16 character driving licence number">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row" style="margin-top: 27px; text-align: center;">
                                        ...
                                        <span style="margin: 5px"><input id="chkTermsAgree" type="checkbox" name="chkTermsAgree" onclick="btnActive()"></span>I Agree <a href="{{route('terms')}}" target="_blank">Terms &amp; Conditions</a> and <a href="{{route('privacy')}}" target="_blank">Privacy Policy</a></label>
                                    </div>
