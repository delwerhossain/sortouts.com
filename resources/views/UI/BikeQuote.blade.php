...
<section class="services single section">
    <div id="divVanQuote" name="divVanQuote" class="container">
        ...
        @else
        <div class="row">
            <h3 style="font-weight: 600; text-align: center;">Bike Insurance Quotation Form</h3>
        </div>
        <x-alert />
        <br>
        <br>
        ...
        <div class="row ">
            <div class="col-sm-12">
                <form method="post" action="{{route('bikequote.store')}}">
                    @csrf
                    <!-- <div id="divCarQuote"> -->
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="otherVehicle" id="otherVehicle" class="form-control fieldwidth" required>
                                            ...
                                            <option value="Own another bike, car or van">Own another bike, car or van</option>
                                            <option value="Have use of another bike">Have use of another bike</option>
                    ...
                    <div class="row setup-content" id="step-3">
                        <div class="col-xs-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row ">
                                    <label class="col-sm-4 col-form-label control-label">Approximate value of the bike right now? <span style="color: red;">*</span>:</label>
                                    <div class="col-sm-8">
                                ...
                                <div id="divIsModified" class="form-group row hidden">
                                    <label class="col-sm-4 col-form-label control-label">Please advice on what modifications have been made to the Bike<span style="color: red;">*</span>:</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">What do you use the Bike for? <span style="color: red">*</span> :</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row" style="margin-top: 27px; text-align: center;">
                                        ...
                                        <span style="margin: 5px"><input id="chkTermsAgree" type="checkbox" name="chkTermsAgree" onclick="btnActive()"></span>I Agree <a href="terms" target="_blank">Terms &amp; Conditions</a> and <a href="privacy" target="_blank">Privacy Policy</a></label>
                                    </div>
