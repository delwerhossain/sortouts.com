...
<body>
    <div>
        <h1 style="margin-top:0pt; margin-bottom:14pt;"><span style="font-family:'Times New Roman';">Car Insurance form, submitted by&nbsp;</span><span style="font-family:'Times New Roman'; color:#3380ff;">{{$firstName }} {{$lastName }}</span></h1>
