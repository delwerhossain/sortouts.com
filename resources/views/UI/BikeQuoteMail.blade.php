...
<head>
    ...
    <title>Bike Quote Document</title>

</head>

<body>
    <div>
        <h1 style="margin-top:0pt; margin-bottom:14pt;"><span style="font-family:'Times New Roman';">Bike Insurance form, submitted by&nbsp;</span><span style="font-family:'Times New Roman'; color:#3380ff;">{{$firstName }} {{$lastName }}</span></h1>
        ...
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">Approximate value of bike at the present (&pound;) :</span></strong><span style="font-family:'Times New Roman';">&nbsp;&pound; {{$carValue }}</span></p>
        ...
        <p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt;"><strong><span style="font-family:'Times New Roman';">What do you use the bike for :</span></strong><span style="font-family:'Times New Roman';">&nbsp;{{$useOfVehicle }}</span></p>
