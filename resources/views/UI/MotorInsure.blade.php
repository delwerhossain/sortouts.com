        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="bread-list">
                    ...
                    <li class="active"><a href="{{route('businessinsurance')}}">Motor Searches</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="services-main">
                    ...
                    <div class="services-slider">
                        ...
                        <div class="single-slide">
                          <a href="{{route('motorquote.index')}}"><img src="fontend/images/motor2.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                        <!-- Single Slide -->
                        <div class="single-slide">
                          <a href="{{route('motorquote.index')}}"><img src="fontend/images/motor1.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                    </div>
                    <!-- End Service Slider -->
                    ...
                    <div class="services-content">
                        <h2 style="text-align: center;">Motor Quote Search</h2>
                        <p>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="services-sidebar">
                    ...
                    <!--/ End Single Sidebar -->
                    <div>
                        <a href="{{route('motorquote.index')}}" class="btn btn-primary" style="width: 100%; margin-top: 10px;">GET MOTOR QOUTE NOW</a>
                    </div>
                    <!-- Single Sidebar -->
