        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="bread-list">
                    ...
                    <li class="active"><a href="{{route('businessinsurance')}}">Business Searches</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="services-main">
                    ...
                    <div class="services-slider">
                        ...
                        <div class="single-slide">
                          <a href="#"><img src="fontend/images/busy2.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                        <!-- Single Slide -->
                        <div class="single-slide">
                          <a href="#"><img src="fontend/images/busy1.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                    </div>
                    <!-- End Service Slider -->
                    ...
                    <div class="services-content">
                        <h2 style="text-align: center;">Business Quote Search</h2>
                        <p>
                ...
                <div class="services-sidebar">
                    ...
                    <div class="single-sidebar category">
                        <ul class="ulStyle">
                            ...
                            <li><a href="{{route('motorquote.index')}}"><i class="fa fa-briefcase"></i>Motor Quote</a></li>
                    ...
                    <!--/ End Single Sidebar -->
                    <div>
                        <a href="" class="btn btn-primary" style="width: 100%; margin-top: 10px;">GET BUSINESS QOUTE NOW</a>
                    </div>
                    <!-- Single Sidebar -->
