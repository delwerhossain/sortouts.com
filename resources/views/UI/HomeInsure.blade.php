        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="bread-list">
                    ...
                    <li class="active"><a href="{{route('homeinsurance')}}">Home Searches</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="services-main">
                    ...
                    <div class="services-slider">
                        ...
                        <div class="single-slide">
                          <a href="#"><img src="fontend/images/homeSlide1.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                        <!-- Single Slide -->
                        <div class="single-slide">
                          <a href="#"> <img src="fontend/images/homeSlide2.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                    </div>
                    <!-- End Service Slider -->
                    ...
                    <div class="services-content">
                        <h2 style="text-align: center;">Home Quote Search</h2>
                        <p>
                ...
                <div class="services-sidebar">
                    ...
                    <div class="single-sidebar category">
                        <ul class="ulStyle">
                            ...
                            <li><a href="{{route('vanquote.index')}}"><i class="fa fa-home"></i>Van Quote</a></li>
                    ...
                    <!--/ End Single Sidebar -->
                    <div>
                        <a href="#" class="btn btn-primary" style="width: 100%; margin-top: 10px;">GET HOME QOUTE NOW</a>
                    </div>
                    <!-- Single Sidebar -->
                    <div class="single-sidebar service" style="margin-top: 10px;">
                        ...
                        <div class="single-service">
                            <a href="{{route('businessinsurance')}}"><img src="fontend/images/more/busy.jpg" alt="" /></a>
                            <div class="caption">
                                <p><a href="{{route('businessinsurance')}}">Business Insurance</a></p>
                            </div>
                        </div>
                    </div>
                    <!--/ End Single Sidebar -->
