        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="bread-list">
                    ...
                    <li class="active"><a href="{{route('carinsurance')}}">Bike Searches</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="services-main">
                    ...
                    <div class="services-slider">
                        ...
                        <div class="single-slide">
                          <a href="{{route('bikequote.index')}}"> <img src="fontend/images/bike1.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                        <!-- Single Slide -->
                        <div class="single-slide">
                          <a href="{{route('bikequote.index')}}"><img src="fontend/images/bike2.jpg" alt="#"></a>
                        </div>
                        <!-- End Single Slide -->
                    </div>
                    <!-- End Service Slider -->
                    ...
                    <div class="services-content">
                        <h2 style="text-align: center;">Bike Quote Search</h2>
                        <p>
                ...
                <div class="services-sidebar">
                    ...
                    <div class="single-sidebar category">
                        <ul class="ulStyle">
                            ...
                            <li><a href="foodquote"><i class="fa fa-briefcase"></i>Hot Food Quote</a></li>
                    ...
                    <!--/ End Single Sidebar -->
                    <div>
                        <a href="{{route('bikequote.index')}}" class="btn btn-primary" style="width: 100%; margin-top: 10px;">GET BIKE QOUTE NOW</a>
                    </div>
                    <!-- Single Sidebar -->
